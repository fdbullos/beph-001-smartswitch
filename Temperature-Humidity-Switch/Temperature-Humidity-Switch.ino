...
const char* ssid     = "BertPabalan"; //enter your ssid/ wi-fi(case sensitive) router name - 2.4 Ghz only
const char* password = "july1966";     // enter ssid password (case sensitive)
char host[] = "https://projectsmartswitch.herokuapp.com"; //- better your Heroku domain name like  "smarttempswitch.herokuapp.com" 
//https://projectsmartswitch.herokuapp.com/
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#define dht_dpin 14 
